...
from src.models.ensemble_model import EnsembleCellTypeModel
...
def main_finetune():
    ...
    pretrain_model_args["promoter_window_size"] = 512
    pretrain_model_args["enhancer_window_size"] = 1024
    pretrain_model_args["domain_window_size"] = 2048
    pretrain_model_args["promoter_layers"] = 24
    pretrain_model_args["enhancer_layers"] = 24
    pretrain_model_args["domain_layers"] = 24
    pretrain_model_args["meta_hidden_dim"] = 512
